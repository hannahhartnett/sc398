...
sd_obp <- ggplot(SD.data, aes(yearID, SD.OBP)) +
  geom_point(colour = 'navy') + geom_smooth(colour = 'navy', se=FALSE, span=0.35) +
...
plotA + coord_polar(theta = 'x') +
  theme(colour = 'navy', axis.text.x = element_text(size = 5),  axis.ticks = element_blank(), axis.text.y = element_blank()) +baseball_theme
```
